...
{
    // MainDab used to have a DLL itself, but it got removed due to skids
    internal class Functions
    {
        ...
        public static void Inject()
        {
            new Thread(() =>
            {
                ...
                {
                    switch (Injector.DllInjector.GetInstance.Inject("RobloxPlayerBeta", @"C:\Windows\" + exploitdllname))//Process name and dll directory
                    {
